          ...
          <div className='flex items-center justify-between gap-8 mb-4 sm:mb-8 md:mb-12'>
            <div className='flex items-center gap-12'>
              <h2 className='text-2xl font-semibold leading-loose text-center text-gray-800 lg:text-3xl dark:text-white'>
                Get a sneak peek of our stunning hotel through our image
                gallery. From luxurious rooms and exquisite dining to
                breathtaking views and relaxing facilities, we invite you to
                take a virtual tour of what awaits you at our hotel. These
                images capture the essence of our hospitality and the
                unforgettable experiences that await your visit.
              </h2>
            </div>
          </div>
